...
def home_page():
    ...
    state_cases_dx = data.state_cases_over_time()
    policies_map_data = {}
    policies_graph_data = {}
    for p in range(1,len(policies_by_state_table[0])):
        ...
        policies_graph_data[policies_by_state_table[0][p]] = data.gen_policy_chart_data(p, policies_by_state_table, state_cases_dx)
    return render_template(
        ...
        policies_graph_data=policies_graph_data)